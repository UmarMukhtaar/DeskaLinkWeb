<nav x-data="{ open: false, scrolled: false }" 
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.user_management')" :active="request()->routeIs('admin.user_management')">
                        {{ __('User Management') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.content_management')" :active="request()->routeIs('admin.content_management')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.user_management')" :active="request()->routeIs('admin.user_management')">
                {{ __('User Management') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.content_management')" :active="request()->routeIs('admin.content_management')">
                {{ __('Content Management') }}
            </x-responsive-nav-link>
        </div>
