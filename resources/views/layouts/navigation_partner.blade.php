<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('partner.services.index')" :active="request()->routeIs('partner.services.index')">
                        {{ __('Jasa') }}
                    </x-nav-link>
                    <x-nav-link :href="route('partner.designs.index')" :active="request()->routeIs('partner.designs.index')">
                        {{ __('Desain') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('partner.services.index')" :active="request()->routeIs('partner.services.index')">
                {{ __('Jasa') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('partner.designs.index')" :active="request()->routeIs('partner.designs.index')">
                {{ __('Desain') }}
            </x-responsive-nav-link>
