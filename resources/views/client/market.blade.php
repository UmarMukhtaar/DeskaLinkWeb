<x-app-layout>
    ...
    @auth
        ...
        <div class="fixed bottom-6 right-6">
            <a href="{{ route('chat.index') }}" class="flex items-center justify-center w-14 h-14 rounded-full bg-red-500 text-white shadow-lg hover:bg-red-600 transition-colors duration-300">
